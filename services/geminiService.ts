...
export const generateMakeup = async ({
  ...
  // CRITICAL: Force the SDK to use 'v1' instead of 'v1beta'
  const genAI = new GoogleGenerativeAI(apiKey);
  const model = genAI.getGenerativeModel(
    { model: "gemini-1.5-flash" },
    { apiVersion: 'v1' } // BU SATIR 404 HATASINI ÇÖZECEK OLAN KISIM
  );
  ...
  try {
    ...
    if (error.message?.includes("429")) {
      ...
      msg = "System communication error (404). Please contact support.";
    }
